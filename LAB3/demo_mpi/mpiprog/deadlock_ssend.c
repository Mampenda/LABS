...
/*
  Slide 56
  Compile:
  mpicc -o deadlock_ssend deadlock_ssend.c
  Run:
  mpiexec -f nfile -n 2 ./deadlock_ssend
*/
...
int main (int argc, char **argv) {
    ...
    if (myrank == 0) {
        ...
        MPI_Ssend(&x,1,MPI_INT,1,msgtag,MPI_COMM_WORLD);
        ...
        MPI_Ssend(&x,1,MPI_INT,0,msgtag,MPI_COMM_WORLD);
